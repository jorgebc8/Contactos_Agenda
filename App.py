...
class App():
    def __init__(self, root):
        ...
        fmenu.add_command(label="Usuario", font=("Arial", "15", "normal"))
        fmenu.add_separator()
        fmenu.add_command(label="Close", command=self.window.quit, font=("Arial", "15", "normal"))

        menub.add_cascade(label="Menu", menu=fmenu)


        inbox_frame = LabelFrame(self.window, bg="#FFFFFF")
        inbox_frame.grid(row=1, column=1)
        ...
        three_frame.grid(row=3, column=3)
        ...
        Label(inbox_frame, text='Numero', bg="#FFFFFF", font=("Arial", "10", "normal")).grid(row=2, column=2)
        inbox_phone = Entry(inbox_frame, font=("Arial", "10", "normal"), width=20)
        inbox_phone.grid(row=1, column=1)

        Label(inbox_frame, text='Email', bg="#FFFFFF", font=("Arial", "10", "normal")).grid(row=3, column=3)
        ...
        delete_button.configure(bg="#FFFFFF", cursor='hand2', font=("Arial", "10", "normal"))
        ...
        def _save(name, phone, email):
            ...
            s_phone = phone
            s_email = email
            with open('contacts_list.csv', 'b') as f:
        ...
        def _search(var_inbox, possition):
            ...
            with open('contacts_list.csv', 's') as f:
                reader = csv.reader(f)
